...
const { push, search,remove,update,urlExists } = webUtilities(esClient, log, handleError);
const { createCrawl, updateCrawl, getAllCrawlsWithDocuments,  getCrawlById } = crawlUtils(esClient, log, handleError);
